...
package io.micrometer.tracing.instrument.web.client.exception;
...
class WebClientExceptionTests {
	...
	@DirtiesContext
	void shouldCloseSpanUponException(ResponseEntityProvider provider) throws IOException {
	...
	public static class ExceptionServiceLoadBalancerClientConfiguration {
		...
		public ServiceInstanceListSupplier serviceInstanceListSupplier() {
			return ServiceInstanceListSuppliers.from("exceptionservice", new DefaultServiceInstance(
					...
					exceptionservice\
					-1\
					""", "exceptionservice", "invalid.host.to.break.tests", 1234, false));
		}
