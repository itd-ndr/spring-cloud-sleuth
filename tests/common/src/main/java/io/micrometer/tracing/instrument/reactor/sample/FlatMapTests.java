...
package io.micrometer.tracing.instrument.reactor.sample;
...
import org.springframework.boot.actuate.autoconfigure.tracing.instrument.reactor.Issue866Configuration;
import org.springframework.boot.actuate.autoconfigure.tracing.instrument.reactor.TraceReactorAutoConfigurationAccessorConfiguration;
import io.micrometer.tracing.exporter.FinishedSpan;
import io.micrometer.tracing.instrument.web.WebFluxSleuthOperators;
...
public abstract class FlatMapTests {
	...
	static class TestManualConfiguration {
		...
		@Bean
		RouterFunction<ServerResponse> handlers(io.micrometer.tracing.Tracer tracing,
