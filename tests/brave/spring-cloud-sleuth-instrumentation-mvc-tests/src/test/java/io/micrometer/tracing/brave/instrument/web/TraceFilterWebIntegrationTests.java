...
public class TraceFilterWebIntegrationTests {
	...
	@Test
	void should_tag_with_value_from_null_expression() {
	...
	@Test
	void should_tag_with_value_from_non_null_expression() {
	...
	@Test
	void should_instrument_logs_for_tomcat_entries(CapturedOutput capture) {
		try {
