...
package io.micrometer.tracing.instrument.scheduling;
...
class TracingOnScheduledTests {
	...
	@Test
	void should_not_create_span_in_the_scheduled_class_that_matches_skip_pattern() throws Exception {
		await().atMost(5, SECONDS).untilAsserted(() -> {
