...
import static org.springframework.boot.actuate.autoconfigure.tracing.zipkin2.ZipkinBraveConfiguration.SPAN_HANDLER_COMPARATOR;

class BraveZipkinAutoConfigurationTests
		extends org.springframework.boot.actuate.autoconfigure.tracing.zipkin2.ZipkinAutoConfigurationTests {
	...
	@Test
	void supportsMultipleReporters() throws Exception {
