...
import io.micrometer.tracing.instrument.grpc.stubs.HelloReply;
import io.micrometer.tracing.instrument.grpc.stubs.HelloRequest;
import io.micrometer.tracing.instrument.grpc.stubs.HelloServiceGrpc;
import io.micrometer.tracing.instrument.grpc.stubs.HelloServiceGrpc.HelloServiceBlockingStub;
import io.micrometer.tracing.instrument.grpc.stubs.HelloServiceGrpc.HelloServiceImplBase;
...
@DirtiesContext
class GrpcTracingIntegrationTests {
	...
	@Test
	void channelBuilderFromAddress() {
