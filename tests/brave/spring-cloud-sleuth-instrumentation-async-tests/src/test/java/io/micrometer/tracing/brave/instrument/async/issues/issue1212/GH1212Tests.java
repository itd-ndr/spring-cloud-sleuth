...
package io.micrometer.tracing.brave.instrument.async.issues.issue1212;
...
class GH1212Tests {
	...
	@Test
	void defaultTaskExecutor() throws Exception {
	...
	@Test
	void singleTaskExecutor() throws Exception {
		try (ConfigurableApplicationContext ctx = new SpringApplicationBuilder(App.class,
	...
	@Test
	void multipleTaskExecutors() throws Exception {
		try (ConfigurableApplicationContext ctx = new SpringApplicationBuilder(App.class,
	...
	@Test
	void customAsyncConfigurer() throws Exception {
		try (ConfigurableApplicationContext ctx = new SpringApplicationBuilder(App.class,
