...
import io.micrometer.tracing.instrument.kafka.KafkaTestUtils;
import io.micrometer.tracing.test.TestTracingAware;

import static org.awaitility.Awaitility.await;

public class KafkaReceiverTest extends io.micrometer.tracing.instrument.kafka.KafkaReceiverTest {
	...
	@Test
	void should_consider_native_headers() {
