...
package io.micrometer.tracing.brave.instrument.kafka;
...
import io.micrometer.tracing.instrument.kafka.TracingKafkaProducer;
...
class TracingKafkaAutoConfigurationTest {
