...
public class KafkaProducerTest extends io.micrometer.tracing.instrument.kafka.KafkaProducerTest {
	...
	@Test
	void should_inject_native_headers() throws InterruptedException {
