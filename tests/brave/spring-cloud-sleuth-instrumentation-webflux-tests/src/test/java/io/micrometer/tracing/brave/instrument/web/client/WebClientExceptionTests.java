...
@SpringBootTest(classes = { WebClientExceptionTests.Config.class,
		io.micrometer.tracing.instrument.web.client.exception.WebClientExceptionTests.TestConfiguration.class },
		properties = { "spring.application.name=exceptionservice" },
		webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class WebClientExceptionTests
		extends io.micrometer.tracing.instrument.web.client.exception.WebClientExceptionTests {
