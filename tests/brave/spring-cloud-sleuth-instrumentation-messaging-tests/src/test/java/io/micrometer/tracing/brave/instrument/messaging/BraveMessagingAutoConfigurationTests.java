...
class BraveMessagingAutoConfigurationTests {
	...
	@Test
	void defaultsToBraveProducerSampler() {
	...
	@Test
	void configuresUserProvidedProducerSampler() {
	...
	@Test
	void defaultsToBraveConsumerSampler() {
		contextRunner().run((context) -> {
	...
	@Test
	void configuresUserProvidedConsumerSampler() {
