...
public class WebClientBraveTests extends ITSpringConfiguredReactorClient {
	...
	@Test
	@Disabled("WebClient is blind to the implementation of redirects")
	@Override
	void redirect() {
	}

	@Test
	@Disabled("WebClient has no portable function to retrieve the server address")
	@Override
	void reportsServerAddress() {
	}

	@Test
	@Disabled("TODO: maybe refactor as an ExchangeFilterFunction to get the request from response")
	@Override
	void readsRequestAtResponseTime() {
	}
