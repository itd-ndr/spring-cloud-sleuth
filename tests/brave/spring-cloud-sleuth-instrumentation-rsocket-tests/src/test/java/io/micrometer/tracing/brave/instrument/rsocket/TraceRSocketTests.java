...
package io.micrometer.tracing.brave.instrument.rsocket;
...
public class TraceRSocketTests extends io.micrometer.tracing.instrument.rsocket.TraceRSocketTests {
	...
	static class Config {
		...
		@Bean
		io.micrometer.tracing.test.TestSpanHandler testSpanHandlerSupplier(
