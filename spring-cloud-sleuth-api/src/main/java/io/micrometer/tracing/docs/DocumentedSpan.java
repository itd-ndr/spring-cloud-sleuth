...
public interface DocumentedSpan {
	...
	default AssertingSpan wrap(Span span) {
		...
		else if (span instanceof AssertingSpan assertingSpan) {
	...
	default AssertingSpanCustomizer wrap(SpanCustomizer span) {
		...
		else if (span instanceof AssertingSpanCustomizer customizer) {
			return customizer;
		}
	...
	default AssertingSpanBuilder wrap(Span.Builder span) {
		...
		else if (span instanceof AssertingSpanBuilder builder) {
			return builder;
		}
