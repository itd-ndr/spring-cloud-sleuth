...
package org.springframework.boot.actuate.autoconfigure.tracing.instrument.async;
...
import io.micrometer.tracing.instrument.async.LazyTraceAsyncCustomizer;
...
public class TraceAsyncCustomAutoConfiguration implements BeanPostProcessor {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		if (bean instanceof AsyncConfigurer configurer && !(bean instanceof LazyTraceAsyncCustomizer)) {
