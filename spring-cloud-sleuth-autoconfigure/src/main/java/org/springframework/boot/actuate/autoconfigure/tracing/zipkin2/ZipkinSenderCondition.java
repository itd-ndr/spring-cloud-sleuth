...
import static org.springframework.boot.actuate.autoconfigure.tracing.zipkin2.ZipkinSenderConfigurationImportSelector.getType;
...
class ZipkinSenderCondition extends SpringBootCondition {
	...
	public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata md) {
		String sourceClass = "";
		if (md instanceof ClassMetadata metadata) {
