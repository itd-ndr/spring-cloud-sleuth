...
public class TraceConfiguration {
	...
	SpanExportingPredicate spanIgnoringSpanExporter(SleuthSpanFilterProperties sleuthSpanFilterProperties) {
		return new SpanIgnoringSpanExportingPredicate(sleuthSpanFilterProperties.getSpanNamePatternsToSkip(),
