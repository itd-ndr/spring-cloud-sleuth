...
import io.micrometer.tracing.instrument.tx.TraceKafkaAwareTransactionManager;
...
public class TraceKafkaPlatformTransactionManagerBeanPostProcessor implements BeanPostProcessor {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		if (bean instanceof KafkaAwareTransactionManager manager && !(bean instanceof TraceKafkaAwareTransactionManager)) {
			return new TraceKafkaAwareTransactionManager(manager, this.beanFactory);
		}
