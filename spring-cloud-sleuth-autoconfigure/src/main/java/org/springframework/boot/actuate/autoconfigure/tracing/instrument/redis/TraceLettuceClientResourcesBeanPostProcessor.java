...
package org.springframework.boot.actuate.autoconfigure.tracing.instrument.redis;
...
import org.springframework.boot.actuate.autoconfigure.tracing.brave.instrument.redis.TraceRedisProperties;
import io.micrometer.tracing.instrument.redis.TraceLettuceClientResourcesBuilderCustomizer;
...
public class TraceLettuceClientResourcesBeanPostProcessor implements BeanPostProcessor {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		if (bean instanceof ClientResources cr) {
