...
import io.micrometer.tracing.instrument.jdbc.DataSourceDecorator;
import io.micrometer.tracing.instrument.jdbc.DataSourceNameResolver;
import io.micrometer.tracing.instrument.jdbc.DataSourceWrapper;
...
public class TraceDataSourceDecoratorBeanPostProcessor implements BeanPostProcessor, Ordered, ApplicationContextAware {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		if (bean instanceof DataSource source && !ScopedProxyUtils.isScopedTarget(beanName)
			...
			return decorate(source, getDataSourceName(bean, beanName), decorators);
		}
		else {
			return bean;
		}
	...
	private String getDataSourceName(Object bean, String beanName) {
		if (HIKARI_AVAILABLE && bean instanceof HikariDataSource hikariDataSource) {
