...
import io.micrometer.tracing.instrument.web.TraceHandlerAdapter;
...
class TraceHandlerFunctionAdapterBeanPostProcessor implements BeanPostProcessor {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		if (bean instanceof HandlerFunctionAdapter adapter) {
			return new TraceHandlerAdapter(adapter, this.beanFactory);
		}
		return bean;
	}
