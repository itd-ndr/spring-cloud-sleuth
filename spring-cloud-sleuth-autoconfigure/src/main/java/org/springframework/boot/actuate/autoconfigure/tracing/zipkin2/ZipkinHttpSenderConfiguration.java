...
package org.springframework.boot.actuate.autoconfigure.tracing.zipkin2;
...
import io.micrometer.tracing.zipkin2.CachingZipkinUrlExtractor;
import io.micrometer.tracing.zipkin2.LoadBalancerClientZipkinLoadBalancer;
import io.micrometer.tracing.zipkin2.RestTemplateSender;
import io.micrometer.tracing.zipkin2.StaticInstanceZipkinLoadBalancer;
import io.micrometer.tracing.zipkin2.WebClientSender;
import io.micrometer.tracing.zipkin2.ZipkinLoadBalancer;
import io.micrometer.tracing.zipkin2.ZipkinProperties;
import io.micrometer.tracing.zipkin2.ZipkinRestTemplateCustomizer;
import io.micrometer.tracing.zipkin2.ZipkinRestTemplateProvider;
import io.micrometer.tracing.zipkin2.ZipkinRestTemplateWrapper;
import io.micrometer.tracing.zipkin2.ZipkinUrlExtractor;
import io.micrometer.tracing.zipkin2.ZipkinWebClientBuilderProvider;
