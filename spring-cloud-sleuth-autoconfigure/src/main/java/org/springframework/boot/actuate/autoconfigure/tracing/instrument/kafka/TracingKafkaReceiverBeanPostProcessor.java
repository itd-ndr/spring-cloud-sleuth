...
import io.micrometer.tracing.instrument.kafka.ReactiveKafkaTracingPropagator;
import io.micrometer.tracing.instrument.kafka.TracingKafkaReceiver;
 ...
 * thanks to
 * {@link org.springframework.boot.actuate.autoconfigure.tracing.instrument.reactor.TraceReactorAutoConfiguration}
 */
public class TracingKafkaReceiverBeanPostProcessor implements BeanPostProcessor {
	...
	public Object postProcessAfterInitialization(@NotNull Object bean, @NotNull String beanName) throws BeansException {
		if (bean instanceof KafkaReceiver receiver && !(bean instanceof TracingKafkaReceiver)) {
			return new TracingKafkaReceiver<>(reactiveKafkaTracingPropagator, receiver);
		}
