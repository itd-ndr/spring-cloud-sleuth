...
package org.springframework.boot.actuate.autoconfigure.tracing.brave.instrument.redis;
...
import org.springframework.boot.actuate.autoconfigure.tracing.instrument.redis.TraceRedisAutoConfiguration;
import io.micrometer.tracing.brave.instrument.redis.ClientResourcesBuilderCustomizer;
import io.micrometer.tracing.brave.instrument.redis.TraceLettuceClientResourcesBuilderCustomizer;
...
public class BraveRedisAutoConfiguration {
	...
	static class LegacyBraveOnlyLettuceConfiguration {
		...
		@ConditionalOnMissingBean({ ClientResources.class,
				io.micrometer.tracing.instrument.redis.TraceLettuceClientResourcesBuilderCustomizer.class })
		...
		@Bean
		@ConditionalOnMissingBean(io.micrometer.tracing.instrument.redis.TraceLettuceClientResourcesBuilderCustomizer.class)
