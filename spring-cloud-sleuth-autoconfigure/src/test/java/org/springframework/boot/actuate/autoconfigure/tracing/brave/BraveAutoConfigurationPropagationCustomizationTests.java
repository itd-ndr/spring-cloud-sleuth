...
class BraveAutoConfigurationPropagationCustomizationTests {
	...
	@Test
	void defaultValueUsedWhenApplicationNameNotSet() {
	...
	@Test
	void allowsCustomizationOfBuilder() {
