...
class TraceTomcatConfigurationTests {
	...
	@Test
	void should_not_register_customizer_when_tomcat_not_present() throws Exception {
	...
	@Test
	void should_not_register_customizer_when_tomcat_customizer_not_present() throws Exception {
		contextRunner
