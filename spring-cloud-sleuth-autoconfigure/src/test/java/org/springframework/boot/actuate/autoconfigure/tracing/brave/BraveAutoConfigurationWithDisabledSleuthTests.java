...
import io.micrometer.tracing.DisableSecurity;
...
class BraveAutoConfigurationWithDisabledSleuthTests {
	...
	@Test
	void shouldNotContainAnyTracingInfoInTheLogs(CapturedOutput capture) {
		log.info("hello");
