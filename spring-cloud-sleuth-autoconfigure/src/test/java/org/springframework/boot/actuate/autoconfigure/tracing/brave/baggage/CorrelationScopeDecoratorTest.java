...
package org.springframework.boot.actuate.autoconfigure.tracing.brave.baggage;
...
class CorrelationScopeDecoratorTest {
	...
	@Test
	void should_set_entries_to_mdc_from_span() {
	...
	@Test
	void should_set_entries_to_mdc_from_span_with_baggage() {
	...
	@Test
	void should_remove_entries_from_mdc_for_null_span() {
		COUNTRY_CODE.updateValue(this.span.context(), "FO");
	...
	@Test
	void should_remove_entries_from_mdc_for_null_span_and_mdc_fields_set_directly() {
	...
	@Test
	void should_remove_entries_from_mdc_from_null_span() {
		MDC.put("traceId", "A");
	...
	@Test
	void should_only_include_whitelist() {
	...
	@Test
	void should_pick_previous_mdc_entries_when_their_keys_are_whitelisted() {
		MDC.put(COUNTRY_CODE.name(), "FO");
