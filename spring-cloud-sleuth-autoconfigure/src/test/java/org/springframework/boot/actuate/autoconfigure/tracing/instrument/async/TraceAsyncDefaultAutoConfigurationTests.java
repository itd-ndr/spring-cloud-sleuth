...
import io.micrometer.tracing.instrument.async.TraceableScheduledExecutorService;
...
class TraceAsyncDefaultAutoConfigurationTests {

	@Autowired
	ScheduledExecutorService executor;

	@Test
	void should_work_with_proxies() {
