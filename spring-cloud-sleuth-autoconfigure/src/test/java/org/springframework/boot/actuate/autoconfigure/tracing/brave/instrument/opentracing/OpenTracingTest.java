...
package org.springframework.boot.actuate.autoconfigure.tracing.brave.instrument.opentracing;
...
class OpenTracingTest {
	...
	@Test
	void extractTraceContextTextMap() {
		Map<String, String> map = singletonMap("b3", "0000000000000001-0000000000000002-1");
	...
	@Test
	void extractTraceContextCaseInsensitive() {
		Map<String, String> map = new LinkedHashMap<>();
		map.put("B3", "0000000000000001-0000000000000002-1");
		map.put("other", "1");
	...
	@Test
	void injectTraceContext_baggage() {
