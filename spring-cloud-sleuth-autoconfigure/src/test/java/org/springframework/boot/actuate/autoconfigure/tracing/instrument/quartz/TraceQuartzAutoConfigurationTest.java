...
package org.springframework.boot.actuate.autoconfigure.tracing.instrument.quartz;
...
import io.micrometer.tracing.instrument.quartz.TracingJobListener;
 ...
 * @author Branden Cash
 */
class TraceQuartzAutoConfigurationTest {
	...
	@Test
	void should_create_job_listener_bean_when_all_conditions_are_met() {
		// when
	...
	@Test
	void should_add_listener_to_trigger_listeners_when_conditions_are_met() {
		// when
		this.contextRunner.run(context -> {
			// expect
	...
	@Test
	void should_add_listener_job_listeners_when_conditions_are_met() {
		// when
		this.contextRunner.run(context -> {
			// expect
			Mockito.verify(context.getBean(Scheduler.class).getListenerManager())
	...
	@Test
	void should_not_create_listener_bean_when_tracing_bean_is_not_present() {
	...
	@Test
	void should_not_create_listener_when_scheduler_bean_is_not_present() {
	...
	@Test
	void should_not_create_listener_when_sleuth_is_disabled() {
		// when
