...
import org.springframework.boot.actuate.autoconfigure.tracing.brave.instrument.messaging.BraveMessagingAutoConfiguration;
import org.springframework.boot.actuate.autoconfigure.tracing.brave.instrument.rpc.BraveRpcAutoConfiguration;
...
class BraveAutoConfigurationCustomizersTests {
	...
	@Test
	void should_apply_baggage_customizer_when_no_baggage_properties_are_defined() {
