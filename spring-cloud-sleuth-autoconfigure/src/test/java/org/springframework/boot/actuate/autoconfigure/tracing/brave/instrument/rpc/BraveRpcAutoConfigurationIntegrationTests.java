...
package org.springframework.boot.actuate.autoconfigure.tracing.brave.instrument.rpc;
...
import io.micrometer.tracing.brave.instrument.rpc.RpcServerSampler;
...
class BraveRpcAutoConfigurationIntegrationTests {
	...
	@Test
	void should_inject_rpc_sampler() {
