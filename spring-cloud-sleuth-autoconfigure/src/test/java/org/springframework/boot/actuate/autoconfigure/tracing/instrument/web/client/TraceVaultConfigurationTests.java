...
class TraceVaultConfigurationTests {
	...
	@Test
	void shouldNotCreateVaultRestTemplateCustomizerWhenVaultNotOnClasspath() {
	...
	@Test
	void shouldNotCreateVaultWebClientCustomizerWhenVaultNotOnClasspath() {
	...
	@Test
	void shouldNotCreateVaultRestTemplateCustomizerWhenSleuthVaultDisabled() {
		this.contextRunner.withPropertyValues("spring.sleuth.vault.enabled=false")
				.run((context) -> assertThat(context).doesNotHaveBean(RestTemplateCustomizer.class));
	}

	@Test
	void shouldNotCreateVaultWebClientCustomizerWhenSleuthVaultDisabled() {
		this.contextRunner.withPropertyValues("spring.sleuth.vault.enabled=false")
				.run((context) -> assertThat(context).doesNotHaveBean(WebClientCustomizer.class));
	}

	@Test
	void shouldCreateVaultRestTemplateCustomizerWhenVaultNotOnClasspath() {
		this.contextRunner.run((context) -> assertThat(context).hasSingleBean(RestTemplateCustomizer.class));
	}

	@Test
	void shouldCreateVaultWebClientCustomizerWhenVaultNotOnClasspath() {
