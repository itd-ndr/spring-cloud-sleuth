...
import org.springframework.boot.actuate.autoconfigure.tracing.SingleSkipPattern;
import org.springframework.boot.actuate.autoconfigure.tracing.TraceNoOpAutoConfiguration;
import io.micrometer.tracing.instrument.web.SkipPatternProvider;
 ...
 */
class SkipPatternProviderConfigTest {
	...
	@Test
	void should_return_null_when_cleared() throws Exception {
	...
	@Test
	void should_pick_skip_pattern_from_sleuth_properties() throws Exception {
	...
	@Test
	void should_combine_skip_pattern_and_additional_pattern_when_all_are_not_empty() {
	...
	@Test
	void should_return_empty_when_management_context_has_no_context_path() throws Exception {
	...
	@Test
	void should_return_management_context_with_context_path() throws Exception {
		contextRunner
				.withConfiguration(
	...
	@Test
	void should_return_management_context_with_context_path_with_placeholders() throws Exception {
		contextRunner
				.withConfiguration(
						UserConfigurations.of(ManagementContextAutoConfiguration.class, ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_empty_when_no_endpoints() {
	...
	@Test
	void should_return_endpoints_without_context_path() {
	...
	@Test
	void should_return_endpoints_with_context_path() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_endpoints_with_context_path_with_placeholders() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_endpoints_without_context_path_and_base_path_set_to_root() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_endpoints_without_context_path_and_base_path_set_to_root_with_placeholders() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_endpoints_with_context_path_and_base_path_set_to_root() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_endpoints_with_context_path_and_base_path_set_to_root_with_placeholder() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_endpoints_with_context_path_and_base_path_set_to_root_different_port() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_endpoints_with_base_path_when_management_port_is_different() {
		contextRunner
				.withConfiguration(
	...
	@Test
	void should_return_endpoints_with_context_path_and_base_path_set_to_root_different_port_with_placeholder() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_endpoints_with_actuator_context_path_only() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_endpoints_with_actuator_context_path_only_with_placeholder() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_endpoints_with_actuator_default_context_path_different_port() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
	...
	@Test
	void should_return_endpoints_with_actuator_context_path_only_different_port() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info",
	...
	@Test
	void should_return_endpoints_with_context_path_different_port() {
		contextRunner.withConfiguration(UserConfigurations.of(ServerPropertiesConfig.class))
				.withPropertyValues("management.endpoints.web.exposure.include=health,info", "management.server.port=0",
						"server.servlet.context-path=foo")
				.run(context -> {
	...
	@Test
	void should_combine_skip_patterns_from_list() throws Exception {
