...
import io.micrometer.tracing.instrument.async.TraceCallable;
import io.micrometer.tracing.instrument.async.TraceRunnable;
 ...
 */
class SpringCloudSleuthDocTests {
	...
	io.micrometer.tracing.Tracer tracer = new BraveTracer(this.braveTracer, new BraveBaggageManager());
	...
	@Test
	void should_set_runnable_name_to_annotated_value() throws ExecutionException, InterruptedException {
	...
	@Test
	void should_set_runnable_name_to_to_string_value() throws ExecutionException, InterruptedException {
		ExecutorService executorService = Executors.newSingleThreadExecutor();
		SpanNamer spanNamer = new DefaultSpanNamer();
	...
	@Test
	void should_wrap_runnable_in_its_sleuth_representative()
	...
	@Test
	void should_wrap_callable_in_its_sleuth_representative()
			throws InterruptedException, ExecutionException, TimeoutException {
		SpanNamer spanNamer = new DefaultSpanNamer();
		// tag::trace_callable[]
