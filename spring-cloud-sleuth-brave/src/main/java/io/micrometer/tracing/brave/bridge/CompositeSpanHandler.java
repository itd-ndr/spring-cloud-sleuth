...
/**
 * Merges {@link SpanExportingPredicate}s and {@link SpanReporter}s into a {@link SpanHandler}.
 *
...
public class CompositeSpanHandler extends SpanHandler {
	...
	public CompositeSpanHandler(List<SpanExportingPredicate> filters, List<SpanReporter> reporters) {
