...
public class SleuthRabbitBeanPostProcessor implements BeanPostProcessor {
	...
	public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
		if (bean instanceof RabbitTemplate template) {
			return rabbitTracing().decorateRabbitTemplate(template);
		}
		...
		else if (bean instanceof DirectRabbitListenerContainerFactory factory) {
			return rabbitTracing()
					.decorateDirectRabbitListenerContainerFactory(factory);
		}
