...
class TracingFeignObjectWrapperTests {
	...
	// gh-1824
	@Test
	void should_not_wrap_nor_modify_lazy_tracing_feign_client() {
	...
	// gh-1528
	@Test
	void should_wrap_feign_loadbalancer_client() {
		Client delegate = mock(Client.class);
	...
	// gh-1528
	@Test
	void should_wrap_feign_retryable_loadbalancer_client() {
		Client delegate = mock(Client.class);
		BlockingLoadBalancerClient loadBalancerClient = mock(BlockingLoadBalancerClient.class);
		LoadBalancerClientFactory loadBalancerClientFactory = mock(LoadBalancerClientFactory.class);
	...
	// gh-1528, gh-1125
	@Test
	void should_wrap_subclass_of_feign_loadbalancer_client() {
		Client delegate = mock(Client.class);
		BlockingLoadBalancerClient loadBalancerClient = mock(BlockingLoadBalancerClient.class);
		LoadBalancerClientFactory loadBalancerClientFactory = mock(LoadBalancerClientFactory.class);
		Mockito.when(beanFactory.getBean(LoadBalancerClient.class)).thenReturn(loadBalancerClient);
		...
		Object wrapped = traceFeignObjectWrapper.wrap(
				new io.micrometer.tracing.instrument.web.client.feign.TracingFeignObjectWrapperTests.TestFeignBlockingLoadBalancerClient(
	...
	// gh-1528, gh-1125
	@Test
	void should_wrap_subclass_of_retryable_feign_loadbalancer_client() {
		Client delegate = mock(Client.class);
		BlockingLoadBalancerClient loadBalancerClient = mock(BlockingLoadBalancerClient.class);
		LoadBalancerClientFactory loadBalancerClientFactory = mock(LoadBalancerClientFactory.class);
		LoadBalancedRetryFactory retryFactory = mock(LoadBalancedRetryFactory.class);
		...
		Object wrapped = traceFeignObjectWrapper.wrap(
				new io.micrometer.tracing.instrument.web.client.feign.TracingFeignObjectWrapperTests.TestRetryableFeignBlockingLoadBalancerClient(
	...
	@Test
	void should_wrap_subclass_of_load_balancer_feign_client() {
		Client delegate = mock(Client.class);
