...
import io.micrometer.tracing.instrument.web.client.TraceExchangeFilterFunction.ClientResponseWrapper;
import org.springframework.web.reactive.function.client.ClientResponse;

class TraceExchangeFilterFunctionHttpClientResponseTests {

	@Test
	void should_return_0_when_invalid_status_code_is_returned() {
	...
	@Test
	void should_return_status_code_when_valid_status_code_is_returned() {
		ClientResponse clientResponse = BDDMockito.mock(ClientResponse.class);
