...
class ExecutorInstrumentorTests {
	...
	@Test
	void should_fallback_to_sleuth_implementation_when_cglib_cannot_be_created_for_executor() throws Exception {
	...
	@Test
	void should_fallback_to_sleuth_implementation_when_cglib_cannot_be_created_for_scheduled_executor()
			throws Exception {
	...
	@Test
	void should_do_nothing_when_bean_is_already_lazy_trace_async_task_executor() throws Exception {
	...
	@Test
	void should_do_nothing_when_bean_is_already_lazy_trace_executor() throws Exception {
	...
	@Test
	void should_do_nothing_when_bean_is_already_lazy_thread_pool_task_executor() throws Exception {
	...
	@Test
	void should_do_nothing_when_bean_is_already_traceable_executor() throws Exception {
	...
	@Test
	void should_do_nothing_when_bean_is_already_traceable_scheduled_executor() throws Exception {
	...
	@Test
	void should_fallback_to_default_implementation_when_exception_thrown() throws Exception {
		ScheduledExecutorService service = Executors.newSingleThreadScheduledExecutor();
	...
	@Test
	void should_throw_exception_from_the_wrapped_object() throws Exception {
	...
	@Test
	void should_use_jdk_proxy_when_executor_has_final_methods() {
	...
	void should_use_cglib_proxy_when_an_executor_has_a_final_package_protected_method() {
		ExecutorInstrumentor beanPostProcessor = new ExecutorInstrumentor(Collections::emptyList, beanFactory);
	...
	void should_use_jdk_proxy_when_an_executor_has_a_final_package_protected_method() {
		ExecutorInstrumentor beanPostProcessor = new ExecutorInstrumentor(Collections::emptyList, beanFactory);
		ScheduledThreadPoolExecutor executor = new ScheduledThreadPoolExecutor(10);
		ScheduledThreadPoolExecutor wrappedExecutor = (ScheduledThreadPoolExecutor) beanPostProcessor
				.instrument(executor, "executor");
	...
	@Test
	void should_use_jdk_proxy_when_executor_service_has_final_methods() throws Exception {
		ExecutorInstrumentor beanPostProcessor = new ExecutorInstrumentor(Collections::emptyList, beanFactory);
	...
	@Test
	void should_use_jdk_proxy_when_async_task_executor_has_final_methods() throws Exception {
		ExecutorInstrumentor beanPostProcessor = new ExecutorInstrumentor(Collections::emptyList, beanFactory);
	...
	@Test
	void should_fallback_to_sleuth_impl_when_thread_pool_task_executor_has_final_methods() {
	...
	@Test
	void proxy_is_not_needed() throws Exception {
	...
	@Test
	void proxy_is_needed() throws Exception {
	...
	@Test
	void should_not_create_proxy() throws Exception {
	...
	// #1463
	@Test
	void should_not_double_instrument_traced_executors() throws Exception {
	...
	// #1569
	@Test
	void should_use_jdk_proxy_when_executor_has_any_final_methods() {
		ExecutorInstrumentor beanPostProcessor = new ExecutorInstrumentor(Collections::emptyList, beanFactory);
	...
	// #1569
	@Test
	void should_use_jdk_proxy_when_executor_has_an_inherited_final_methods() {
		ExecutorInstrumentor beanPostProcessor = new ExecutorInstrumentor(Collections::emptyList, beanFactory);
