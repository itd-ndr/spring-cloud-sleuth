...
class SpanNameProviderTest {
	...
	@Test
	void should_return_default_on_null_input() {
	...
	@Test
	void should_return_default_on_empty_input() {
		SpanNameProvider provider = new SpanNameProvider();
		String sql = "";
	...
	@Test
	void should_return_word_select_on_input_starting_with_word_select() {
		SpanNameProvider provider = new SpanNameProvider();
	...
	@Test
	void should_return_word_update_on_input_starting_with_word_update() {
		SpanNameProvider provider = new SpanNameProvider();
	...
	@Test
	void should_return_word_insert_on_input_starting_with_word_insert() {
		SpanNameProvider provider = new SpanNameProvider();
	...
	@Test
	void should_return_word_delete_on_input_starting_with_word_delete() {
		SpanNameProvider provider = new SpanNameProvider();
	...
	@Test
	void should_handle_sql_without_redundant_spaces() {
		SpanNameProvider provider = new SpanNameProvider();
		String sql = "select*from test_table;";
	...
	@Test
	void should_return_lower_case_input_for_input_containing_only_one_word() {
		SpanNameProvider provider = new SpanNameProvider();
		String sql = "BEGIN";
