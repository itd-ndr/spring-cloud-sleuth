...
package io.micrometer.tracing.instrument.web.mvc;
...
import static io.micrometer.tracing.instrument.web.mvc.SpanCustomizingHandlerInterceptor.setErrorAttribute;
import static io.micrometer.tracing.instrument.web.mvc.SpanCustomizingHandlerInterceptor.setHttpRouteAttribute;
...
public final class SpanCustomizingAsyncHandlerInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object o) {
		...
		if (span instanceof SpanCustomizer customizer) {
			handlerParser.preHandle(request, o, customizer);
		}
		return true;
	}
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		Object span = request.getAttribute(SpanCustomizer.class.getName());
		if (span instanceof SpanCustomizer customizer) {
			handlerParser.postHandle(request, handler, modelAndView, customizer);
		}
	}
