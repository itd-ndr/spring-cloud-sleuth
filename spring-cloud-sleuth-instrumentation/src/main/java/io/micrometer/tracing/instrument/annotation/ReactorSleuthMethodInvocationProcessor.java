...
import io.micrometer.tracing.instrument.reactor.TraceContextPropagator;
...
public class ReactorSleuthMethodInvocationProcessor extends AbstractSleuthMethodInvocationProcessor {
	...
	private Object proceedUnderReactorSpan(MethodInvocation invocation, NewSpan newSpan, ContinueSpan continueSpan)
		...
		if (publisher instanceof Mono mono) {
			return new MonoSpan(mono, this, newSpan, span, invocation, log);
		}
		else if (publisher instanceof Flux flux) {
			return new FluxSpan(flux, this, newSpan, span, invocation, log);
		}
		else {
