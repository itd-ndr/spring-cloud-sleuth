...
import io.micrometer.tracing.internal.LazyBean;
...
public class HttpClientBeanPostProcessor implements BeanPostProcessor {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		...
		if (bean instanceof HttpClient client) {
			...
			return client.doOnResponseError(new TracingDoOnErrorResponse(springContext))
	...
	static final class HttpClientRequestWrapper implements io.micrometer.tracing.http.HttpClientRequest {
	...
	static final class HttpClientResponseWrapper implements io.micrometer.tracing.http.HttpClientResponse {
		...
		public HttpClientRequestWrapper request() {
			if (request == null) {
				if (delegate instanceof HttpClientRequest clientRequest) {
					this.request = new HttpClientRequestWrapper(clientRequest, null);
				}
			}
			return this.request;
		}
